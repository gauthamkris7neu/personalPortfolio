...
export function ContactSection() {
  return (
    <section
      id="contact"
      className="border-t border-blue-100 bg-blue-50 py-12 md:py-16 lg:py-24"
      aria-labelledby="contact-heading"
    >
      <div className="container px-4 md:px-6">
        <h2
          id="contact-heading"
          className="mb-6 text-center text-2xl md:text-3xl font-bold tracking-tight text-blue-950 lg:text-4xl"
        >
          Get In Touch
        </h2>
        <p className="mx-auto mb-8 max-w-md text-center text-blue-700 text-sm md:text-base">
          ...
          <div className="flex flex-col justify-center">
            <div className="mb-6 space-y-2 text-center md:text-left">
              ...
              <p className="text-blue-700 text-sm md:text-base">
                ...
                <a
                  ...
                  aria-label="Email Alex at alex@example.com"
                >
            ...
            <div className="flex justify-center md:justify-start space-x-4" aria-label="Social media links">
              <Link
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-blue-600 shadow-sm transition-colors hover:bg-blue-100 hover:text-blue-700"
        ...
        <p className="mt-12 text-center text-xs md:text-sm text-blue-500">
